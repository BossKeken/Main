...
public class Main extends JFrame implements ActionListener {
    ...
    public Main() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/MainTitle.png"));
        ...
        // Main Center Code
        ImageIcon loginImg1 = new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/login.png"));
        ...
        ImageIcon signUpImg1 = new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/signup.png"));
        ...
        ImageIcon mainPic1 = new ImageIcon(
                ClassLoader.getSystemResource("capstoneproject/icons/ElearningMain.png"));
        ...
        // Footer Panel Code
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/footer.png"));
