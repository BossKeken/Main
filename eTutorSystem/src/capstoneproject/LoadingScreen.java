...
public class LoadingScreen extends JFrame {
    ...
    public LoadingScreen() {
        ...
        upperPic = new JLabel();
        upperPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/loadingIconImg.png")));
        ...
        textLbl = new JLabel("Welcome To E-Tutor System");
        ...
        backgroundPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("capstoneproject/icons/background.png")));
